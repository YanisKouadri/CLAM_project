...
To understand how to use create_patches_fp.py, please refer to the author's page (workflow = create_patches_fp.py then extract_features.ipynb then simple_training.ipynb). Also, I didn't have the time to comment the code yet.
